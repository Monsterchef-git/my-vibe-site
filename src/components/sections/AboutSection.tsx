...
export default function AboutSection({
  ...
  return (
    <ScrollSectionPrimitive id={id} scrollTone="white" className={cx('pt-20 md:pt-8 overflow-hidden', className)}>
      ...
      {/* ── Headline editorial ── */}
      <div className="mb-16 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(260px,320px)] lg:items-end lg:gap-12">
        ...
        <div className="space-y-12">
          ...
          <div className="grid gap-6 border-t border-zinc-800/60 pt-8 md:grid-cols-2">
            ...
            <p className="font-mono text-sm leading-relaxed text-zinc-500">
              ...
              work as Creative Chef at <MonoToken kind="project">Wink Eventos</MonoToken>{' '}
              and lead the landing experience for <MonoToken kind="project">tecnical.app</MonoToken>.
            </p>
          </div>
        </div>
