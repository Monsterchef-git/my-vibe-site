...
export default function GastronomySection({
  ...
  return (
    <ScrollSectionPrimitive id={id} scrollTone="lime" className={cx('space-y-10', className)}>
      ...
      <div className="reveal grid auto-rows-[250px] grid-cols-2 gap-4 md:auto-rows-[300px] md:grid-cols-4">
        <CardPrimitive
          tone="lime"
        ...
        <CardPrimitive tone="neutral" className="group relative row-span-2 overflow-hidden">
          <Image
